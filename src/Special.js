...
import { ClockFill, Search, ArrowRightCircleFill, Reception4, Reception3, Reception2, Person, PersonFill, PlusCircleFill } from "react-bootstrap-icons";
  ...
  const courses = [
    {
      ...
      description: "Learn Machine Learning from the best in the industry through our advanced course",
    },
    {
    ...
    {
      name: "Cyber Security",
      description: "Learn Cyber Security through various lessons from licensed instructors",
    },
    {
        ...
        <header className="App-header">
          <div className="w-fit sm:w-[80vw] max-w-[1700px] mt-[3.5rem] h-full flex flex-col gap-3 rounded-xl drop-shadow-2xl bg-gray-950 p-4">
            ...
            <div className="grid justify-center gap-3 lg:grid-cols-2">
              {courses.map((course) => (
                <div className="bg-gray-900 grid grid-child min-h-[150px] 2xl:h-[300px] rounded-xl gap-4 p-3">
                  <div
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="mb-1 text-lg font-bold text-left 2xl:text-2xl flex items-center justify-between">
                      {course.name}
                      <button>
                      <PlusCircleFill/>
                      </button>
                    ...
                    <div className="bg-gray-800 whitespace-pre rounded-xl flex flex-row p-2 font-semibold gap-4">
